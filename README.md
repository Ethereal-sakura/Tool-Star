...
## 📣 Latest News
- **[July 25, 2025]**: 🚀🚀🚀 We have released a new project [ARPO](https://github.com/dongguanting/ARPO) , which significantly accelerates the training process for Tool-star (approximately **4 times faster** ) and supports training for the Qwen2.5, Qwen3, and Llama3 series models! We welcome everyone to try and star it!!
